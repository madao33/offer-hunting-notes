...
--
-- Host: localhost    Database: bjpowermode
-- ------------------------------------------------------
...
INSERT INTO `dept_bak` VALUES (10,'sales','beijing'),(11,'madao233','chengdu'),(11,'madao233','chengdu'),(11,'madao233','chengdu');
...
--
-- Temporary view structure for view `emp_dept_view`
--
...
INSERT INTO `mytable` VALUES (7566,'JONES'),(7698,'BLAKE'),(7782,'CLARK');
...
INSERT INTO `t_class` VALUES (100,'CQU-BME-1'),(101,'CQU-BME-2');
...
INSERT INTO `t_student` VALUES (1,'jack',100),(2,'lucy',100),(3,'lilwi',100),(4,'mary',100),(5,'madao',101),(6,'madao233',101),(7,'lihong',101),(8,'theShy',101),(9,'theTang',101);
...
INSERT INTO `t_user` VALUES ('madao'),('madao'),('madao233'),('madao111'),('madao222');
...
INSERT INTO `t_vip` VALUES (1,'zhangsan'),(2,'zhangsan'),(3,'zhangsan'),(4,'zhangsan'),(5,'zhangsan'),(6,'zhangsan'),(7,'zhangsan'),(8,'zhangsan'),(9,'zhangsan');
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `emp_dept_view` AS select `e`.`ENAME` AS `ename`,`e`.`SAL` AS `sal`,`d`.`DNAME` AS `dname` from (`emp` `e` join `dept` `d` on((`e`.`DEPTNO` = `d`.`DEPTNO`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2022-03-02  9:34:05
